        ...
        >
          <template #top>
            <div class="q-pa-xs row q-gutter-sm">
              <XBtn
                v-if="auth.hasPermission('categories_create')"
          ...
          <template #body-cell-actions="props">
            <q-td :props="props">
              <div class="row no-wrap q-gutter-xs">
                <XBtnView
                  v-if="auth.hasPermission('categories_view')"
                  @click="
                    $q.dialog({
                ...
                />
                <XBtnEdit
                  v-if="auth.hasPermission('categories_edit')"
                  @click="
                    $q.dialog({
                ...
                />
                <XBtnDelete
                  v-if="auth.hasPermission('categories_delete')"
                  @click="
                    $q.dialog({
...
const visibleColumns = computed(() => {
  ...
  if (!auth.hasPermissions(['categories_view', 'categories_edit', 'categories_delete'])) {
